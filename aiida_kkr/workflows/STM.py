...
from aiida.orm import Group, load_group, LinkType
...
class STM_wc(WorkChain):
    ...
    def combine_potentials(self, impurity_to_combine, da, db):
        ...
        if 'imp_cls' in impurity_to_combine:
            ...
            new_combined_imp_info = Dict(dict=new_combined_imp_info)
    ...
    def STM_lmdos_run(self):
        ...
        builder.params_kkr_overwrite = Dict(dict={'NSHELD': 1500})
        ...
        self.ctx.kkrimp_params_dict['dos_params'][
            'nepts'] = 9  # Here 9 because of the interpolated files that aren't generated
