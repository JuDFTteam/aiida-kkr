...
def test_kkrimp_full_wc(clear_database_before_test, voronoi_local_code, kkrhost_local_code, kkrimp_local_code, run_with_cache):
    """
...
def test_kkrimp_full_Ag_Cu_onsite(clear_database_before_test, voronoi_local_code, kkrhost_local_code, kkrimp_local_code, run_with_cache):
    """
