...
def write_graph(node, label=''):
    ...
    graph.recurse_ancestors(node, depth=None, link_types=(), annotate_links='both', include_process_outputs=True, print_func=None)
    graph.recurse_descendants(node, depth=None, link_types=(), annotate_links='both', include_process_inputs=True, print_func=None)
...
def test_combine_imps_params_kkr_overwrite(clear_database_before_test, kkrhost_local_code, kkrimp_local_code, run_with_cache, nopytest=False):
    """
...
def test_combine_imps_reuse_gf(clear_database_before_test, kkrhost_local_code, kkrimp_local_code, run_with_cache, nopytest=False):
    """
