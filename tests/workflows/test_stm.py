...
@pytest.mark.xfail(
    strict=False,
    reason='IndexError in tools_STM_scan.lattice_generation, see issue #185. strict=False so '
    'an upstream STM fix landing does not turn the suite red for passing.'
)
